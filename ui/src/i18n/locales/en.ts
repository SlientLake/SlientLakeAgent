...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    topology: "9-agent org hierarchy and status.",
    mcp: "MCP Server registry and toggles.",
    kb: "Knowledge base create, delete, access.",
    chat: "Gateway chat for quick interventions.",
    chatroom: "Multi-agent A2A chatroom collaboration.",
