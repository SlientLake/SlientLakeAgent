...
export const zh_CN: TranslationMap = {
  ...
  subtitles: {
    ...
    skills: "技能和 API 密钥。",
    nodes: "配对设备和命令。",
    topology: "9 Agent 组织层级与在线状态。",
    mcp: "MCP Server 注册表与开关。",
    kb: "知识库创建、删除与权限管理。",
    chat: "网关聊天，快速干预。",
    chatroom: "多 Agent A2A 聊天室协作。",
  ...
  usage: {
    page: {
      subtitle: "查看 Token 去向、会话峰值和费用驱动因素。",
    },
    common: {
      emptyValue: "—",
      unknown: "未知",
