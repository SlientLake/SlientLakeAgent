    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="SilentLake" />
          <div class="login-gate__title">SilentLake</div>
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>${t("overview.connection.step1")}<code>silentlake gateway run</code></li>
            <li>${t("overview.connection.step2")}<code>silentlake dashboard --no-open</code></li>
