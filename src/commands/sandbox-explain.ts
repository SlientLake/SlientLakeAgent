...
const SANDBOX_DOCS_URL = "https://github.com/SlientLake/SlientLakeAgent/tree/main/docs/sandbox";
...
export async function sandboxExplainCommand(
  ...
  lines.push("");
  lines.push(
    `${key("Docs:")} ${formatDocsLink("/sandbox", "github.com/SlientLake/SlientLakeAgent/tree/main/docs/sandbox")}`,
  );
