...
export async function startGatewayServer(
  ...
  // Register with SilentLake Python platform (non-blocking, best-effort)
  void import("../platform/register.js").then(({ startHeartbeat }) => {
    startHeartbeat(defaultAgentId, port);
  });
